...
import { updateUser, closePasswordModal, setExpiredValue } from '../actions';
...
class PasswordChangeForm extends React.Component {
    ...
    sendData() {
        ...
        dispatch(updateUser(userUpdate)).then(() => dispatch(setExpiredValue())).then(() => dispatch(closePasswordModal()));
    }
